...
public class GrammarRule : MonoBehaviour {
	...
	public void InsertToRuleList () {
		...
		Debug.Log(welsh);
		DbSetup.InsertTupleToTable("VocabRuleList", english, welsh, RuleNumber);
	...
	public void DeleteFromRuleList () {
		...
		DbSetup.DeleteTupleInTable("VocabRuleList", ruleFields);
	...
	public void DeleteRule() {
		...
		DbSetup.DeleteTupleInTable(	"VocabGrammar",
								 	fields);
		Destroy(gameObject);
	}
