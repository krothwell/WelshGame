...
namespace DataUI.ListItems {
    public class NewCompleteQuestTaskResultBtn : NewChoiceResultBtn {
        ...
        public override void InsertResult() {
            ...
            DbCommands.InsertTupleToTable("TasksCompletedByDialogueChoices", newResultID, PlayerChoiceID, taskID);
